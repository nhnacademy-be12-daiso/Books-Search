...
import com.daisobook.shop.booksearch.books_search.dto.projection.BookDetailProjection;
...
import com.daisobook.shop.booksearch.books_search.service.policy.DiscountPolicyService;
...
class BookFacadeTest {
    ...
    class UnitTests {
        ...
        void getBookUpdateView_success() throws JsonProcessingException {
            var detail = mock(com.daisobook.shop.booksearch.books_search.dto.projection.BookUpdateViewProjection.class);
            when(bookCoreService.getBookUpdateView_Id(5L)).thenReturn(detail);

            var view = mock(com.daisobook.shop.booksearch.books_search.dto.response.book.BookUpdateView.class);
        ...
        void getBookList_newReleases_success() throws JsonProcessingException {
            ...
            // projections
            var proj = mock(com.daisobook.shop.booksearch.books_search.dto.projection.BookListProjection.class);
            ...
            // mapper -> data map
            Map<Long, com.daisobook.shop.booksearch.books_search.dto.BookListData> dataMap =
                    Map.of(11L, mock(com.daisobook.shop.booksearch.books_search.dto.BookListData.class));
            ...
            // discount mapping
            Map<Long, com.daisobook.shop.booksearch.books_search.dto.DiscountDTO.Request> dtoMap = Map.of();
            when(bookMapper.toDiscountDTOMapByBookListData(dataMap)).thenReturn(dtoMap);
            Map<Long, com.daisobook.shop.booksearch.books_search.dto.DiscountDTO.Response> discountMap = Map.of();
            when(discountPolicyService.getDiscountPriceMap(dtoMap)).thenReturn(discountMap);

            // final DTO list
            var resp = mock(com.daisobook.shop.booksearch.books_search.dto.response.book.BookListRespDTO.class);
            when(bookMapper.toBookRespDTOList(dataMap, discountMap, Set.of(11L))).thenReturn(List.of(resp));

            var result = bookFacade.getBookList(null, com.daisobook.shop.booksearch.books_search.entity.BookListType.NEW_RELEASES, 1L);
        ...
        void findBooksByIdIn_success() throws JsonProcessingException {
            var proj = mock(com.daisobook.shop.booksearch.books_search.dto.projection.BookInfoListProjection.class);
            ...
            var resp = mock(com.daisobook.shop.booksearch.books_search.dto.response.order.OrderBooksInfoRespDTO.class);
        ...
        void getOrderBookList_success() {
            var summ = mock(com.daisobook.shop.booksearch.books_search.dto.projection.BookSummeryProjection.class);
            when(bookCoreService.getBookSummeryByIds(List.of(3L))).thenReturn(List.of(summ));

            var dto = mock(com.daisobook.shop.booksearch.books_search.dto.response.order.OrderBookSummeryDTO.class);
        ...
        void getBookList_idsNull_throws() {
            ...
            assertThatThrownBy(() -> bookFacade.getBookList(null, com.daisobook.shop.booksearch.books_search.entity.BookListType.NEW_RELEASES, 1L))
                    .isInstanceOf(com.daisobook.shop.booksearch.books_search.exception.custom.book.NotFoundBook.class);
        }
