...
import com.daisobook.shop.booksearch.books_search.dto.projection.DiscountValueListProjection;
...
import com.daisobook.shop.booksearch.books_search.repository.policy.DiscountPolicyRepository;
import com.daisobook.shop.booksearch.books_search.service.policy.impl.DiscountPolicyServiceImpl;
...
class DiscountPolicyServiceTest {
    ...
    void getDiscountValueByBookIdOrCategoryIdsOrPublisherId_combinesAllSources() {
        ...
        when(discountPolicyRepository.findAllByTargetTypeAndTargetIdAndIsActive(org.mockito.ArgumentMatchers.eq(com.daisobook.shop.booksearch.books_search.entity.policy.TargetType.GLOBAL), isNull(), eq(true)))
                .thenReturn(List.of(global));
        when(discountPolicyRepository.findAllByTargetTypeAndTargetIdInAndIsActive(org.mockito.ArgumentMatchers.eq(com.daisobook.shop.booksearch.books_search.entity.policy.TargetType.CATEGORY), anyList(), eq(true)))
                .thenReturn(List.of(category));
        when(discountPolicyRepository.findAllByTargetTypeAndTargetIdAndIsActive(org.mockito.ArgumentMatchers.eq(com.daisobook.shop.booksearch.books_search.entity.policy.TargetType.PUBLISHER), eq(10L), eq(true)))
                .thenReturn(List.of(publisher));
        when(discountPolicyRepository.findAllByTargetTypeAndTargetIdAndIsActive(org.mockito.ArgumentMatchers.eq(com.daisobook.shop.booksearch.books_search.entity.policy.TargetType.PRODUCT), eq(99L), eq(true)))
        ...
        verify(discountPolicyRepository, times(1)).findAllByTargetTypeAndTargetIdAndIsActive(org.mockito.ArgumentMatchers.eq(com.daisobook.shop.booksearch.books_search.entity.policy.TargetType.GLOBAL), isNull(), eq(true));
        verify(discountPolicyRepository, times(1)).findAllByTargetTypeAndTargetIdInAndIsActive(org.mockito.ArgumentMatchers.eq(com.daisobook.shop.booksearch.books_search.entity.policy.TargetType.CATEGORY), anyList(), eq(true));
        verify(discountPolicyRepository, times(1)).findAllByTargetTypeAndTargetIdAndIsActive(org.mockito.ArgumentMatchers.eq(com.daisobook.shop.booksearch.books_search.entity.policy.TargetType.PUBLISHER), eq(10L), eq(true));
        verify(discountPolicyRepository, times(1)).findAllByTargetTypeAndTargetIdAndIsActive(org.mockito.ArgumentMatchers.eq(com.daisobook.shop.booksearch.books_search.entity.policy.TargetType.PRODUCT), eq(99L), eq(true));
    }
