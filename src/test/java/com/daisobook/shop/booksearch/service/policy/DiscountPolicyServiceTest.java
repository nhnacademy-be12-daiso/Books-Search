...
import com.daisobook.shop.booksearch.dto.projection.DiscountValueListProjection;
...
import com.daisobook.shop.booksearch.repository.policy.DiscountPolicyRepository;
import com.daisobook.shop.booksearch.service.policy.impl.DiscountPolicyServiceImpl;
...
class DiscountPolicyServiceTest {
    ...
    void getDiscountValueByBookIdOrCategoryIdsOrPublisherId_combinesAllSources() {
        ...
        when(discountPolicyRepository.findAllByTargetTypeAndTargetIdAndIsActive(org.mockito.ArgumentMatchers.eq(TargetType.GLOBAL), isNull(), eq(true)))
                .thenReturn(List.of(global));
        when(discountPolicyRepository.findAllByTargetTypeAndTargetIdInAndIsActive(org.mockito.ArgumentMatchers.eq(TargetType.CATEGORY), anyList(), eq(true)))
                .thenReturn(List.of(category));
        when(discountPolicyRepository.findAllByTargetTypeAndTargetIdAndIsActive(org.mockito.ArgumentMatchers.eq(TargetType.PUBLISHER), eq(10L), eq(true)))
                .thenReturn(List.of(publisher));
        when(discountPolicyRepository.findAllByTargetTypeAndTargetIdAndIsActive(org.mockito.ArgumentMatchers.eq(TargetType.PRODUCT), eq(99L), eq(true)))
        ...
        verify(discountPolicyRepository, times(1)).findAllByTargetTypeAndTargetIdAndIsActive(org.mockito.ArgumentMatchers.eq(TargetType.GLOBAL), isNull(), eq(true));
        verify(discountPolicyRepository, times(1)).findAllByTargetTypeAndTargetIdInAndIsActive(org.mockito.ArgumentMatchers.eq(TargetType.CATEGORY), anyList(), eq(true));
        verify(discountPolicyRepository, times(1)).findAllByTargetTypeAndTargetIdAndIsActive(org.mockito.ArgumentMatchers.eq(TargetType.PUBLISHER), eq(10L), eq(true));
        verify(discountPolicyRepository, times(1)).findAllByTargetTypeAndTargetIdAndIsActive(org.mockito.ArgumentMatchers.eq(TargetType.PRODUCT), eq(99L), eq(true));
    }
